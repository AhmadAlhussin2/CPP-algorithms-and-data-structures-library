...
int SegmentTreeSet::size() const { return _size; }

bool SegmentTreeSet::empty() const { return _size == 0; }
...
void SegmentTreeSet::insert(const int &element) { SegmentTreeSet::update(1, 0, _capacity - 1, element, 1); }

void SegmentTreeSet::remove(int key) { SegmentTreeSet::update(1, 0, _capacity - 1, key, 0); }
